/**!
 * @preserve nanoGALLERY v5.0.0beta
...
nanoGALLERY v5.0.0beta release notes.

TODO: browser prefix in helpers

self-hosted: pouvoir définir taille des imagettes + demo
...
- thumbnail hover effects: new option to delay the effect, changed default duration from 200ms to 400ms
...
- **enableElevatezoom**: enable the jQuery Image Zoom plugin (requires jquery.elevatezoom.js)
  *boolean; Default:`false`*
...
- added management of browser prefix for a better browser support even with jQuery v1.7.1
  ...
  function TnAni( $e, n, anime, item, eltClass) {
    ...
    if( g_tnHE[n].delay > 0 ) {
      ...
      if( g_aengine == 'transition' ) {
        ...
        $e.delay(g_tnHE[n].delay)[g_aengine](anime, {duration:g_tnHE[n].duration , easing:g_tnHE[n].easing });
      }
      else {
