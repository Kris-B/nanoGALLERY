/**!
 * @preserve nanoGALLERY v5.5.0beta2
...
nanoGALLERY v5.5.0beta2 release notes.

TODO: remove pagination earlier
...
;(function ($) {
  ...
  function nanoGALLERY() {
    ...
    */
    ...
    G.toRender= [],
    G.metaViewportInitial ='',
    G.msTouchActionInitial= '',
    G.touchActionInitial='';
    ...
    */
    ...
    this.Initiate = function( element, params ) {
      ...
      if( jQuery('head meta[name=viewport]')[0] !== undefined ) {
        G.metaViewportInitial=jQuery('head meta[name=viewport]')[0].content;
      }
...
G.msTouchActionInitial=jQuery('body').css('msTouchAction');
G.touchActionInitial=jQuery('body').css('touchAction');
//jQuery('body').css({msTouchAction:'none', touchAction:'none'});      
console.log(G.msTouchActionInitial);
console.log(G.touchActionInitial);
...
//      window.cancelAnimationFrame(G.viewerResizeTimerID);
    ...
    function CloseInternalViewer( setLocationHash ) {
      ...
      if( G.containerViewerDisplayed ) {
        ...
        // jQuery('head meta[name=viewport]').remove();
        // jQuery('head').prepend('<meta name="viewport" content="'+G.metaViewportInitial+'" />');
        if( G.msTouchActionInitial !== null ) {
          jQuery('body').css({'msTouchAction':G.msTouchActionInitial});
        }
        if( G.touchActionInitial !== null ) {
          jQuery('body').css({'touchAction':G.touchActionInitial});
        }
