...
;(function ($) {
    ...
    */
    ...
    this.SetUnselectedItems = function(items){
      ...
      indexes.forEach(function(it){
        if(G.I[it].$elt !== null){
          // thumbnailSelection(G.I[it].$elt, G.I[it], G.I[it].selected);
          thumbnailSelection(G.I[it], false);
        }
      });
    };
  ...
  //A    url = url + "&callback=?";
    ...
    function ResizeGalleryWidthtAuto() {
      ...
      tnFeaturedH=tnFeaturedH+G.tn.outerHeight.get()+G.tn.labelHeight;
    ...
    function thumbnailBuild( item, idx, foundDesc ) {
      ...
      if( G.tn.settings.getH() == 'auto' ) {
        newElt[newEltIdx++]='<div class="imgContainer nGEvent" style="width:'+G.tn.settings.getW()+'px;"><img class="image nGEvent" src="'+src+'" alt=" " style="max-width:'+G.tn.settings.getW()+'px;"></div>';
      }
      else if( G.tn.settings.getW() == 'auto' ) {
          newElt[newEltIdx++]='<div class="imgContainer nGEvent" style="height:'+G.tn.settings.getH()+'px;"><img class="image nGEvent" src="'+src+'" alt=" " style="max-height:'+G.tn.settings.getH()+'px;" ></div>';
        }
        else {
          newElt[newEltIdx++]='<div class="imgContainer nGEvent" style="width:'+G.tn.settings.getW()+'px;height:'+G.tn.settings.getH()+'px;"><img class="image nGEvent" src="'+src+'" alt=" " style="max-width:'+G.tn.settings.getW()+'px;max-height:'+G.tn.settings.getH()+'px;" ></div>';
        }
    ...
    function setThumbnailSize( $elt, item ) {
      ...
      if( G.tn.settings.getH() == 'auto' ) {
        ...
        if( G.tn.settings.getW() == 'auto' ) {
          ...
          item.thumbFullHeight=G.tn.outerHeight.get()+G.tn.labelHeight;
          ...
          // GRID LAYOUT
          item.thumbFullHeight=G.tn.outerHeight.get();  //+G.tn.labelHeight;  //G.tn.defaultFullHeight;
