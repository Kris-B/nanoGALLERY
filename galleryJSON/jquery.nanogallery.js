...
todo 5.3.0:
  deeplinking images?
	watermark (thumbnails + images)
	https://github.com/dimsemenov/PhotoSwipe --> Micro animation engine
	zoom pan
	render image size on images/thumbnails / picasa demo images
...
this.thumbImgHeight = 0;           // thumbnail image height
  ...
  function JsonParseData(albumIdx, data) {
    ...
    jQuery.each(data, function(i,item){
      ...
      var src=gO.itemsBaseURL+JsonConvertCharset(item.src);
      var thumbsrc=gO.itemsBaseURL+JsonConvertCharset(item.srct);
